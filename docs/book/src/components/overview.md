...
Catallaxy ships with 30 built-in components across 18 categories. Each component is a self-contained module that declares configuration options and writes Kubernetes resources into deployment phases when enabled.
