...
in
{
  # Renders the lab's ops commands into a bash CLI: flag parsing, per-command
  # help, validation and dispatch. It is a renderer, which is why it lives here
  # rather than in the module that declares the options.
  opsToolScript =
    {
      labName,
      commandsByCategory,
